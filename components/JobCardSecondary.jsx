...
const JobCardSecondary = ({ job }) => {
  ...
  return (
    <div className={"overflow-hidden max-h-80"}>
      <Toaster richColors />
      <Card className={"p-1 rounded-[22px] h-80 text-sm"}>
        <div
          style={{ backgroundColor: pastelColor || "rgb(253, 230, 138)" }}
          className={`rounded-[16px] h-[80%] w-full lg:h-[80%] p-4 flex flex-col gap-4 transition-all duration-500 ease-in-out`}
        >
      ...
      <div
        className={`relative bottom-16 p-1 opacity-100 lg:duration-200 md:transition-all`}
      >
