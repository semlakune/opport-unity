    ...
    <section className={styles.field}>
      <div className="container">
        <div className={"flex flex-col md:flex-row justify-between items-center gap-8"}>
          <h1 className={"text-2xl md:text-3xl underline decoration-wavy md:no-underline"}>Most Demanding Categories.</h1>
          <Button variant={"link"} className={"text-end text-sm md:text-lg font-bold whitespace-nowrap px-0 hidden md:block"}>Explore all fields <span
            className={"ml-2"}><FontAwesomeIcon icon={faAngleRight}/></span></Button>
        </div>
        <div className={"flex flex-wrap justify-evenly items-center py-10 md:py-20 mx-auto gap-6"}>
        ...
        <Button variant={"link"} className={"w-full text-center text-sm font-bold whitespace-nowrap px-0 md:hidden"}>Explore all fields <span className={"ml-2"}><FontAwesomeIcon icon={faAngleRight}/></span></Button>

        <div className={"flex items-center justify-center py-10 gap-10"}>
          <Separator className={"w-16 md:w-60"}/>
          <h1 className={"text-center whitespace-nowrap text-2xl"}>How it’s Work?</h1>
          <Separator className={"w-16 md:w-60"}/>
        </div>
        <div className={"flex flex-wrap justify-center items-start"}>
          <div className={"flex flex-grow basis-3 flex-col justify-center items-center text-center gap-4 px-5 md:px-20 mb-10"}>
