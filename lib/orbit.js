          ...
          <g className="m1_stage" opacity={0}>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
              ...
              <g className="m1Orb orb4b">
                <FontAwesomeIcon icon={faFlaskGear} width={30} height={30} color={"#106504"} opacity={0.6} />
              </g>
              <g className="m1Orb orb4">
                <FontAwesomeIcon icon={faUserDoctor} width={40} height={40} color={"#ca9100"} opacity={0.6} />
              </g>
            </g>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
              ...
              <g className="m1Orb orb3c">
                <FontAwesomeIcon icon={faPaintbrush} width={20} height={20} color={"#390669"} opacity={0.3} />
              </g>
              <g className="m1Orb orb3b">

              </g>
              <g className="m1Orb orb3">
                <FontAwesomeIcon icon={faCode} width={50} height={50} color={"#0c604c"} opacity={0.6} />
              </g>
            </g>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
