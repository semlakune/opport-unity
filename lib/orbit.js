...
import {
  ...
  faMarker,
  faPenCircle,
  faChartMixedUpCircleDollar, faGearComplexCode
...
export default function Orbit() {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      gsap.set('.m1_stage', { x: '50%', opacity: 1, transform: 'translate(60%, 40%)' });
    };
    ...
    const handleMouseMove = (e) => {
      ...
      m1cGroupRefs.current.forEach((element, i) => {
        const magnitude = (m1cGroupRefs.current.length - i) * 10;
        gsap.to(element, {
          x: xOffset * magnitude,
          y: yOffset * magnitude,
          overwrite: 'auto',
          ...
          <g className="m1_stage" opacity={0}>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
              ...
              <g className="m1Orb orb4b">
                <FontAwesomeIcon icon={faCirclePhone} width={30} height={30} color={"#106504"} opacity={0.6} />
              </g>
              <g className="m1Orb orb4">
                <FontAwesomeIcon icon={faChartMixedUpCircleDollar} width={20} height={20} color={"#ca9100"} opacity={0.6} />
              </g>
            </g>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
              ...
              <g className="m1Orb orb3c">
                <FontAwesomeIcon icon={faPenCircle} width={20} height={20} color={"#390669"} opacity={0.3} />
              </g>
              <g className="m1Orb orb3b">

              </g>
              <g className="m1Orb orb3">
                <FontAwesomeIcon icon={faGearComplexCode} width={50} height={50} color={"#0c604c"} opacity={0.6} />
              </g>
            </g>
            <g className="m1_cGroup" ref={setM1cGroupRef}>
            ...
            <g className="m1_cGroup" ref={setM1cGroupRef}>
              <circle className="m1OrbBlank" cx={0} cy={50} r={20} fill="#F8BDCE" />
              <circle
